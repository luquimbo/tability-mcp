 ...
 *
 * This module provides a function to register all Tability MCP tools
 * on an McpServer instance. This allows the same tools to be used
 * with different transports (stdio, HTTP, etc.)
 */
...
/**
 * Registers all Tability tools on the given MCP server.
